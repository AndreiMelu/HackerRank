...
//        int nrEqualities = scanner.nextInt();
//
//        for (int i = 0; i < nrEqualities; i++) {
//            for (int j = 0; j <= m; j++) {
//
//            }
//        }
...
public class MultipleLinearRegression {
    public static void main(String[] args) {
        ...
        int m = scanner.nextInt();
        int nrEqualities = scanner.nextInt();
        double [][] X = new double[nrEqualities][m + 1];
        double [][] Y   = new double[nrEqualities][1];

        for (int row = 0; row < nrEqualities; row++) {
            X[row][0] = 1;
            for (int col = 1; col <= m; col++) {
                X[row][col] = scanner.nextDouble();
            }
            Y[row][0] = scanner.nextDouble();
        }
        ...
        for (int i = 0; i < q; i++) {
            ...
            for (int row = 1; row < sizeB; row++) {
                result += scanner.nextDouble() * B[row][0];
            }
